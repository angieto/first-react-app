    ...
    render() {
        return (
            <div className="Contest">
                ...
                </div> {/* end Proposed Names */}

                <div className="panel panel-info">
                    <div className="panel-heading">
                        <h3 className="panel-title">Proposed a New Name</h3>
                    </div>
                    <div className="panel-body">
                        <form onSubmit={this.handleSubmit}>
                            <div className="input-group">
                                <input type="text" placeholder="New name..." ref="newNameInput" className="form-control" />
